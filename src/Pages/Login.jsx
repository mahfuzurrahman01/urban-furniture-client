            ...
            <div className="md:w-full w-11/12 max-w-md mx-auto p-8 space-y-3 rounded-xl bg-transparent shadow-2xl shadow-accent   text-gray-100">
                ...
                <form onSubmit={handleLogin} noValidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" id="email" placeholder="Your email" className="w-full px-4 py-3 rounded-md border-gray-400 bg-amber-100 text-gray-800 focus:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label htmlFor="password" className="block    text-gray-600">Password</label>
                        <input type="password" name="password" id="password" placeholder="Your password" className="w-full px-4 py-3 rounded-md border-gray-400 bg-amber-100 text-gray-800 focus:border-violet-400" />
                        <div className="flex justify-end text-xs    text-gray-400">
                            <a rel="noopener noreferrer" href="    ">Forgot Password?</a>
                        </div>
                    </div>
                    <button className="block w-full p-3 text-center rounded-sm  bg-primary text-white">Sign In</button>
                </form>
                ...
                <p className="text-xs text-center sm:px-6 text-gray-400">Don't have an account?
                    <Link rel="noopener noreferrer" to='/registration' className="underline text-gray-700">Sign up</Link>
                </p>
            </div>
        </div>
    );
